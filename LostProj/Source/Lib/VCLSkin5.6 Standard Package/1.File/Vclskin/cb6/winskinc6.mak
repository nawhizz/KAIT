...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = D:\PROGRA~1\Borland\CBUILD~2\Projects\BPL\WinSkinC6.bpl
OBJFILES = WinSkinC6.obj WinSkinReg.obj
RESFILES = WinSkinC6.res WinSkinReg.dcr vclskin.res
MAINSOURCE = WinSkinC6.cpp
RESDEPEN = $(RESFILES)
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
LIBRARIES = bcb2kaxserver.lib indy.lib dbxcds.lib dclocx.lib soaprtl.lib bcbie.lib \
    ...
    dsnapcrba.lib visualdbclx.lib teeqr.lib dss.lib tee.lib teedb.lib \
    teeui.lib qrpt.lib bdecds.lib cds.lib ibxpress.lib vcldbx.lib bdertl.lib \
    adortl.lib vcldb.lib
PACKAGES = rtl.bpi designide.bpi vcl.bpi vclx.bpi bcbsmp.bpi
...
LIBPATH = $(BCB)\Projects\Lib;$(BCB)\lib\obj;$(BCB)\lib;..\demo2\CB6
WARNINGS= -w-par
PATHCPP = .;
PATHASM = .;
PATHPAS = .;
...
PFLAGS = -$Y- -$W -$O- -$L- -$D- -$C- -$A8 -v -JPHNE -M -LUDesignIde
RFLAGS = 
AFLAGS = /mx /w2 /zd
LFLAGS = -lD:\PROGRA~1\Borland\CBUILD~2\Projects\LIB -D"VCLSkin C6" -aa -Tpp -x -Gn \
    -Gl -Gi -v
# ---------------------------------------------------------------------------
