...
// (DO NOT EDIT: machine generated header) 'Winskindata.pas' rev: 20.00
...
#pragma option push -b-
enum TSkinOption { xoMDIScrollbar, xoMenuMerge, xoTransparent, xoPreview, xoParentBackGround, xoNoFocusRect, xoToolbarBK, xoToolbarButton, xoMDIChildBorder, xoMenuBG, xoCaptionButtonHint, xoFormScrollbar };
#pragma option pop
...
typedef StaticArray<Graphics::TColor, 20> TShemeColors;

#pragma option push -b-
enum TSkinFormType { sfMainform, sfOnlyThisForm, sfDialog, sfDLL };
#pragma option pop

typedef void __fastcall (__closure *TOnFormSkin)(System::TObject* Sender, System::UnicodeString aName, bool &DoSkin);

typedef void __fastcall (__closure *TOnSkinForm)(System::TObject* Sender, HWND ahwnd, System::UnicodeString aName);

class DELPHICLASS TSkinData;
typedef void __fastcall (__closure *TOnSkinControl)(Classes::TComponent* Sender, TSkinData* SkinData, Controls::TControl* Form, Controls::TControl* Control, System::UnicodeString ControlClass, Classes::TComponent* &SkinnedControl);
...
public:
	...
	__fastcall TDataSkinObject(System::UnicodeString AIDName);
...
public:
	...
	__fastcall TDataSkinBorder(System::UnicodeString AIDName);
...
public:
	/* TDataSkinObject.Create */ inline __fastcall TDataSkinTitle(System::UnicodeString AIDName) : TDataSkinObject(AIDName) { }
...
public:
	...
	bool newover;
	bool newdown;
	__fastcall TDataSkinButton(System::UnicodeString AIDName);
...
public:
	...
	int Visibility1;
public:
	/* TDataSkinObject.Create */ inline __fastcall TDataSkinSysButton(System::UnicodeString AIDName) : TDataSkinObject(AIDName) { }
...
public:
	...
	int Alignment;
public:
	/* TDataSkinObject.Create */ inline __fastcall TDataSkinBoxLabel(System::UnicodeString AIDName) : TDataSkinObject(AIDName) { }
...
private:
	typedef DynamicArray<Graphics::TColor> _TSkinData__1;
	
	typedef DynamicArray<TDataSkinSysButton*> _TSkinData__2;
	
	
private:
	System::UnicodeString fskinfile;
	...
	bool hashint;
	void __fastcall ReadMenuBar(TDataSkinObject* &aobject, System::UnicodeString aname);
	void __fastcall ReadProgress(TDataSkinObject* &aobject, System::UnicodeString aname);
	void __fastcall ReadRGB(System::UnicodeString Section, System::UnicodeString aname, Graphics::TColor &value);
	Graphics::TColor __fastcall GetColor(const System::UnicodeString s1, Graphics::TColor acolor);
	void __fastcall SetFrame(void);
	int __fastcall GetSectionNum(System::UnicodeString asection, System::UnicodeString aname);
	void __fastcall WriteData(Classes::TStream* Stream);
	void __fastcall ReadData(Classes::TStream* Stream);
	System::UnicodeString __fastcall GetSkinStore();
	void __fastcall SetSkinStore(const System::UnicodeString Value);
	...
	void __fastcall ReadTrack(TDataSkinObject* &aobject, System::UnicodeString aname);
	void __fastcall CreateLogo(void);
	void __fastcall CreateCaptionFont(void);
	void __fastcall CreateMinCaption(void);
	
protected:
	void __fastcall ReadObject(TDataSkinObject* &aobject, System::UnicodeString aname);
	void __fastcall ReadObject2(TDataSkinBorder* &aobject, System::UnicodeString aname, System::UnicodeString image2);
	void __fastcall ReadButton(void);
	void __fastcall ReadSysButton(void);
	void __fastcall LoadFromIni(System::UnicodeString filename);
	void __fastcall ReadBord(void);
	void __fastcall ReadColor(void);
	void __fastcall ReadColor2(TShemeColor item, System::UnicodeString key, Graphics::TColor cdefault);
	void __fastcall ReadTitle(TDataSkinObject* aobject, System::UnicodeString aname);
	void __fastcall ReadBoxLabel(TDataSkinBoxLabel* &aobject, System::UnicodeString aname);
...
public:
	...
	bool Empty;
	TShemeColors Colors;
	StaticArray<bool, 20> hasColors;
	_TSkinData__1 ColorPreset;
	Graphics::TBitmap* SysIcon;
	TDataSkinTitle* Title;
	_TSkinData__2 SysBtn;
	...
	StaticArray<TDataSkinBorder*, 4> border;
	Classes::TStringList* sectionlist;
	StaticArray<int, 10> PresetColors;
	HBRUSH BGBrush;
	bool MenuMsg;
	...
	void __fastcall Readbmp(Graphics::TBitmap* bmp, System::UnicodeString fname);
	bool __fastcall GetPrecolor(Graphics::TColor &acolor, int n);
	System::UnicodeString __fastcall GetFileName(System::UnicodeString s);
	void __fastcall Uninstall(void);
	void __fastcall Install(void);
	void __fastcall DoFormSkin(unsigned ahwnd, System::UnicodeString aname, bool &Doskin);
	...
	void __fastcall ChangeProperty(System::TObject* control, System::UnicodeString aprop, System::UnicodeString value);
	...
	void __fastcall DoDebug(System::UnicodeString s);
	void __fastcall ChangeForm(Forms::TForm* aform);
	void __fastcall GetAppIcon(void);
	void __fastcall ActivateHint(const Types::TRect &aRect, const System::UnicodeString AHint);
...
__published:
	...
	__property System::UnicodeString SkinFile = {read=fskinfile, write=LoadFromFile};
	__property System::UnicodeString SkinStore = {read=GetSkinStore, write=SetSkinStore};
...
extern PACKAGE System::WideString __fastcall StrToWideStr(const System::AnsiString S);
extern PACKAGE System::AnsiString __fastcall WideStringToStringEx(const System::WideString WS);
extern PACKAGE System::WideString __fastcall _WStr(System::WideChar * lpString, int cchCount);
extern PACKAGE int __fastcall Tnt_DrawTextW(HDC hDC, System::WideString wString, Types::TRect &lpRect, unsigned uFormat);
extern PACKAGE Graphics::TColor __fastcall RGBToColor(System::Byte R, System::Byte G, System::Byte B);
extern PACKAGE Graphics::TColor __fastcall strcolor(System::UnicodeString s);
