...
// (DO NOT EDIT: machine generated header) 'Winsubclass.pas' rev: 20.00
...
protected:
	...
	void __fastcall doLogMsg(System::UnicodeString aid, const Messages::TMessage &msg);
	...
	void __fastcall DrawFocus(HDC hDC, System::WideString wString, const Types::TRect &rc, unsigned uFormat);
...
public:
	...
	void __fastcall DrawCaption(Graphics::TCanvas* acanvas, const Types::TRect &rc, System::WideString text, bool enabled, bool defaulted, System::Word Alignment = (System::Word)(0x1));
	void __fastcall DrawImgCaption(Graphics::TCanvas* acanvas, const Types::TRect &rc, unsigned ImgList, int imgIndex, System::WideString text, int talign = 0x1);
	int __fastcall TextHeight(HDC dc, const System::UnicodeString s);
...
public:
	...
	void __fastcall Attach(TSkinControl* aobj, Controls::TWinControl* aControl, System::Byte aType);
	void __fastcall AttachHwnd(TSkinControl* aobj, unsigned ahwnd, System::Byte aType);
...
protected:
	...
	bool redraw;
	bool isdefault;
	void __fastcall DrawBtnText(Graphics::TCanvas* acanvas, const Types::TRect &rc, System::UnicodeString text, System::Word Alignment = (System::Word)(0x1));
...
public:
	...
	bool Colored;
	bool Auto;
	StaticArray<Graphics::TBitmap*, 3> Bitmaps;
};
...
protected:
	StaticArray<TMPButton, 9> Buttons;
	int count;
	Winskindata::TSkinData* fsd;
	bool IsDown;
	TMPBtnType BtnClick;
...
protected:
	void __fastcall Defaultpaint(Graphics::TCanvas* acanvas, const Types::TRect &rc, int I, System::WideString text = L"", Classes::TAlignment Align = (Classes::TAlignment)(0x0));
	void __fastcall drawitem(HDC dc, const Types::TRect &rc, int I, System::WideString text = L"", Classes::TAlignment Align = (Classes::TAlignment)(0x0));
...
private:
	typedef DynamicArray<Types::TRect> _TSkinTab__1;
	
	
protected:
	_TSkinTab__1 CloseRect;
...
class DELPHICLASS TSkinCheckList;
class PASCALIMPLEMENTATION TSkinCheckList : public TSkinScrollbar
{
	typedef TSkinScrollbar inherited;
	
protected:
	unsigned hHwnd;
	void __fastcall DrawItem(HDC dc, int Index, const Types::TRect &Rc, Windows::TOwnerDrawState State);
	void __fastcall CNDrawItem(Messages::TWMDrawItem &Message);
	
public:
	virtual bool __fastcall BeforeProc(Messages::TMessage &Message);
public:
	/* TSkinScrollbar.Create */ inline __fastcall virtual TSkinCheckList(Classes::TComponent* AOwner) : TSkinScrollbar(AOwner) { }
	/* TSkinScrollbar.Destroy */ inline __fastcall virtual ~TSkinCheckList(void) { }
...
private:
	typedef DynamicArray<Types::TRect> _TSkinHeader__1;
	
	
protected:
	_TSkinHeader__1 Items;
	int indexitem;
	...
	void __fastcall DrawItemImgCaption(Graphics::TCanvas* acanvas, const Types::TRect &rc, unsigned ImgList, int imgIndex, System::WideString text, int talign = 0x1);
...
extern PACKAGE System::UnicodeString __fastcall GetProperty(System::TObject* control, System::UnicodeString aprop);
extern PACKAGE int __fastcall GetIntProperty(System::TObject* control, System::UnicodeString aprop);
extern PACKAGE System::UnicodeString __fastcall GetEnumProperty(System::TObject* control, System::UnicodeString aprop);
extern PACKAGE System::WideString __fastcall GetStringProp(System::TObject* control, System::UnicodeString aprop);
extern PACKAGE System::TMethod __fastcall GetObjMethod(System::TObject* control, System::UnicodeString aprop);
extern PACKAGE System::TObject* __fastcall GetObjProp(System::TObject* control, System::UnicodeString aprop, System::TClass MinClass);
extern PACKAGE void __fastcall SetProperty(System::TObject* control, System::UnicodeString aprop, System::UnicodeString value);
extern PACKAGE System::WideString __fastcall StringReplaceW(System::WideString s, System::WideString s1, System::WideString s2);
extern PACKAGE void __fastcall MyDrawCaption(Graphics::TCanvas* acanvas, const Types::TRect &rc, System::WideString text, bool enabled, bool defaulted, Classes::TAlignment Alignment = (Classes::TAlignment)(0x2));
extern PACKAGE void __fastcall DrawArrow(Graphics::TCanvas* ACanvas, int X, int Y, int Orientation);
extern PACKAGE void __fastcall MyDrawImgCaption(Graphics::TCanvas* acanvas, const Types::TRect &rc, Imglist::TCustomImageList* ImgList, int imgIndex, System::UnicodeString text, bool enabled, bool defaulted, Classes::TAlignment Alignment = (Classes::TAlignment)(0x2));
