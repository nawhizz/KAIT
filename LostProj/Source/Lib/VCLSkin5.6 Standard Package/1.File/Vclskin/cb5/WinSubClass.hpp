...
public:
	...
	void __fastcall MoveArrow(const Windows::TRect &r);
public:
	#pragma option push -w-inl
...
protected:
	bool FReentr;
	void __fastcall DrawPicbtn(Graphics::TCanvas* acanvas, const Windows::TRect &rc);
...
protected:
	...
	void __fastcall DrawBorder(HDC dc, const Windows::TRect &rc);
	void __fastcall DrawArrow(HDC dc, const Windows::TRect &rc, int i);
...
public:
	#pragma option push -w-inl
	/* TSkinControl.Create */ inline __fastcall virtual TSkinTransObj(Classes::TComponent* AOwner) : TSkinControl(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TSkinControl.Create */ inline __fastcall virtual TSkinProgress(Classes::TComponent* AOwner) : TSkinControl(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TSkinControl.Create */ inline __fastcall virtual TSkinTrackBar(Classes::TComponent* AOwner) : TSkinControl(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TSkinControl.Create */ inline __fastcall virtual TSkinToolbar(Classes::TComponent* AOwner) : TSkinControl(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
protected:
	...
	void __fastcall DrawControl1(HDC dc, const Windows::TRect &rc);
	void __fastcall PaintControl1(HDC adc);
...
public:
	#pragma option push -w-inl
	/* TSkinControl.Create */ inline __fastcall virtual TSkinEdit(Classes::TComponent* AOwner) : TSkinControl(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TSkinControl.Create */ inline __fastcall virtual TSkinSizer(Classes::TComponent* AOwner) : TSkinControl(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TSkinControl.Create */ inline __fastcall virtual TSkinBoxH(Classes::TComponent* AOwner) : TSkinControl(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TSkinControl.Create */ inline __fastcall virtual TSkinTabSheet(Classes::TComponent* AOwner) : TSkinControl(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TSkinControl.Create */ inline __fastcall virtual TSkinObjImage(Classes::TComponent* AOwner) : TSkinControl(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TSkinControl.Create */ inline __fastcall virtual TSkinAdvPage(Classes::TComponent* AOwner) : TSkinControl(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	...
	virtual void __fastcall InitScrollbar(Controls::TWinControl* acontrol, Winskindata::TSkinData* sd, 
		Graphics::TCanvas* acanvas, Classes::TComponent* sf);
	virtual void __fastcall DrawControl(HDC dc, const Windows::TRect &rc);
	virtual void __fastcall SkinChange(void);
};
...
public:
	virtual void __fastcall DrawControl(HDC dc, const Windows::TRect &rc);
	void __fastcall InitScrollbar(Controls::TWinControl* acontrol, Winskindata::TSkinData* sd, Graphics::TCanvas* 
		acanvas, Classes::TComponent* sf);
	virtual void __fastcall Unsubclass(void);
	__fastcall virtual ~TSkinScControl(void);
public:
	#pragma option push -w-inl
	/* TSkinControl.Create */ inline __fastcall virtual TSkinScControl(Classes::TComponent* AOwner) : TSkinControl(
		AOwner) { }
	#pragma option pop
...
protected:
	unsigned hHwnd;
	void __fastcall DrawItem(HDC dc, int Index, const Windows::TRect &Rc, Windows::TOwnerDrawState State
		);
...
public:
	#pragma option push -w-inl
	/* TSkinScrollbar.Create */ inline __fastcall virtual TSkinCheckList(Classes::TComponent* AOwner) : 
		TSkinScrollbar(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
typedef DynamicArray<Windows::TRect >  WinSubClass__24;
...
protected:
	DynamicArray<Windows::TRect >  Items;
	int indexitem;
	void __fastcall WMMouseMove(Messages::TMessage &Message);
	void __fastcall DrawItem(unsigned ImgList, Graphics::TCanvas* acanvas, const Windows::TRect &rc, int 
		index);
	void __fastcall DrawItemImgCaption(Graphics::TCanvas* acanvas, const Windows::TRect &rc, unsigned ImgList
		, int imgIndex, WideString text, int talign);
...
public:
	#pragma option push -w-inl
	/* TSkinControl.Create */ inline __fastcall virtual TSkinHeader(Classes::TComponent* AOwner) : TSkinControl(
		AOwner) { }
	#pragma option pop
...
protected:
	...
	void __fastcall drawitem(HDC dc, const Windows::TRect &rc, Comctrls::TListColumn* acolumn);
...
public:
	#pragma option push -w-inl
	/* TSkinScrollbar.Create */ inline __fastcall virtual TSkinListView(Classes::TComponent* AOwner) : 
		TSkinScrollbar(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
extern PACKAGE void __fastcall FillColor(HDC dc, const Windows::TRect &rc, Graphics::TColor acolor);
...
extern PACKAGE Sysutils::TMethod __fastcall GetObjMethod(System::TObject* control, AnsiString aprop)
	;
extern PACKAGE System::TObject* __fastcall GetObjProp(System::TObject* control, AnsiString aprop, TMetaClass* 
	MinClass);
...
extern PACKAGE void __fastcall MyDrawCaption(Graphics::TCanvas* acanvas, const Windows::TRect &rc, WideString 
	text, bool enabled, bool defaulted, Classes::TAlignment Alignment);
extern PACKAGE void __fastcall DrawArrow(Graphics::TCanvas* ACanvas, int X, int Y, int Orientation);
	
extern PACKAGE void __fastcall MyDrawImgCaption(Graphics::TCanvas* acanvas, const Windows::TRect &rc
	, Imglist::TCustomImageList* ImgList, int imgIndex, AnsiString text, bool enabled, bool defaulted, 
