...
static unsigned long sqlctx = 161675;
...
{10,4130,0,0,0,
5,0,0,1,0,0,27,23,0,0,4,4,0,1,0,1,97,0,0,1,97,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,0,0,13,53,0,0,3,0,0,1,0,2,97,0,0,2,3,0,0,2,97,0,0,
63,0,0,2,0,0,15,62,0,0,0,0,0,1,0,
78,0,0,3,0,0,32,68,0,0,0,0,0,1,0,
};
...

{
    ...
    sqlstm.sqptdso = sqlstm.sqtdso;
    sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
    if (sqlca.sqlcode < 0) goto end_of_fetch;
}
