...
uses
  ...
  common_lib,Grids, WinSkinData,u_LOSTT240Q, ComObj;

const
  TITLE   = '설문결과통계조회(지역)';
  PGM_ID  = 'LOSTT240Q_CHILD';  

type
  Tfm_LOSTT240Q_CHILD = class(TForm)
...
var
  fm_LOSTT240Q_CHILD: Tfm_LOSTT240Q_CHILD;

implementation

{$R *.dfm}

procedure Tfm_LOSTT240Q_CHILD.FormCreate(Sender: TObject);
begin
...
procedure Tfm_LOSTT240Q_CHILD.InitComponent;
begin
...
procedure Tfm_LOSTT240Q_CHILD.btn_InquiryClick(Sender: TObject);
var
  i:Integer;
  totalCount:Integer;
...
procedure Tfm_LOSTT240Q_CHILD.disableComponents;
begin
...
procedure Tfm_LOSTT240Q_CHILD.enableComponents;
begin
...
procedure Tfm_LOSTT240Q_CHILD.initStrGrid;
begin
  with grd_display do begin
    RowCount      :=  2;
    ColCount      :=  9;
...
procedure Tfm_LOSTT240Q_CHILD.grd_displayDblClick(Sender: TObject);
var i : integer;
...
begin
  fm_LOSTT240Q.cmb_topic.Clear;
  fm_LOSTT240Q.cmb_topic.Items.Add(   CfillChar(grd_display.Cells[8,grd_display.Row] ,' ',100)
...
procedure Tfm_LOSTT240Q_CHILD.btn_CloseClick(Sender: TObject);
begin
  close;
end;

procedure Tfm_LOSTT240Q_CHILD.FormClose(Sender: TObject;
...
procedure Tfm_LOSTT240Q_CHILD.grd_displayDrawCell(Sender: TObject; ACol,
  ARow: Integer; Rect: TRect; State: TGridDrawState);
var
  grid:TStringGrid;
  S:String;
...
procedure Tfm_LOSTT240Q_CHILD.StringGrid_DrawCell(Sender: TObject; ACol, ARow: Integer; Rect: TRect; i_align : integer);
var
  LeftPos: Integer;
  TopPos : integer;
  CellStr: string;
...
procedure Tfm_LOSTT240Q_CHILD.btn_LinkClick(Sender: TObject);
begin
  grd_displayDblClick(sender);
end;

procedure Tfm_LOSTT240Q_CHILD.FormShow(Sender: TObject);
begin
  Self.InitComponent;
end;

procedure Tfm_LOSTT240Q_CHILD.btn_resetClick(Sender: TObject);
begin
  Self.InitComponent;
end;

procedure Tfm_LOSTT240Q_CHILD.btn_queryClick(Sender: TObject);
var
	cmdStr    :String;
  filePath  :String;
  f         :TextFile;
