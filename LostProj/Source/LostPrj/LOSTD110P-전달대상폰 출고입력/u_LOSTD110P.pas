{*---------------------------------------------------------------------------
프로그램ID    : LOSTD110P (사업자 귀속단말기 출고 입력)
프로그램 종류 : Online
작성자	      : 최 대 성
작성일	      : 2011. 09. 02
완료일	      : ####. ##. ##
...
const
  TITLE   = '사업자 귀속단말기 출고 입력';
  PGM_ID  = 'LOSTD110P';

type
  Tfrm_LOSTD110P = class(TForm)
    Bevel2          : TBevel;
    Bevel12         : TBevel;
    Bevel4          : TBevel;
    Bevel1          : TBevel;
...
{----------------------------------------------------------------------------}
procedure Tfrm_LOSTD110P.FormCreate(Sender: TObject);
begin
...
procedure Tfrm_LOSTD110P.btn_CloseClick(Sender: TObject);
begin
     close;
end;

procedure Tfrm_LOSTD110P.InitComponents;
begin
...
*******************************************************************************}
procedure Tfrm_LOSTD110P.disableComponents;
begin
...
*******************************************************************************}
procedure Tfrm_LOSTD110P.enableComponents;
begin
  dte_Ip_Dt.Enabled    := True;
...
*******************************************************************************}
procedure Tfrm_LOSTD110P.initStrGrid;
...
*
*******************************************************************************}
procedure Tfrm_LOSTD110P.grd_displayDrawCell(Sender: TObject; ACol,
  ARow: Integer; Rect: TRect; State: TGridDrawState);
var
  grid:TStringGrid;
  S:String;
...
*******************************************************************************}
procedure Tfrm_LOSTD110P.grd_displayKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
*******************************************************************************}
procedure Tfrm_LOSTD110P.StringGrid_DrawCell(Sender: TObject; ACol, ARow: Integer; Rect: TRect; i_align : integer);
var
  LeftPos: Integer;
  TopPos : integer;
  CellStr: string;
...
*******************************************************************************}
procedure Tfrm_LOSTD110P.Copy1Click(Sender: TObject);
var
  select: TGridRect;
  str:String;
  i,j:Integer;
...
procedure Tfrm_LOSTD110P.btn_InquiryClick(Sender: TObject);
var
    i,j : Integer;
...
begin
  ...
  if (TMAX.SendString('INF003','LostD110P')     < 0)  then  goto LIQUIDATION;
  ...
  //서비스 호출
  if not TMAX.Call('LOSTD110P') then
  begin
...
procedure Tfrm_LOSTD110P.btn_AddClick(Sender: TObject);
var
    i : Integer;
...
procedure Tfrm_LOSTD110P.btn_resetClick(Sender: TObject);
begin
  Self.InitComponents
end;

procedure Tfrm_LOSTD110P.FormShow(Sender: TObject);
begin
  //콤포넌트 초기화
  InitComponents;
end;
