...
const
	titles: Array[0..11] of String =(
            ...
            '    계');
type
TLOSTA240Q_PRT_HEAD = class(TObject)
public
...
function TLOSTA240Q_PRT_HEAD.getLength(index :Integer):Cardinal;
begin
	result:= len[index];
...
function TLOSTA240Q_PRT_HEAD.getRightPosition(index: Integer):Cardinal;
begin
...
Constructor TLOSTA240Q_PRT_HEAD.Create(margin, maxWidth:Integer; Canvas:TCanvas);
var
	i:Integer;
    gap:Integer;
    xstart:Integer;
