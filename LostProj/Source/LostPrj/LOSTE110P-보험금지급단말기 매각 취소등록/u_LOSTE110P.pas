{*---------------------------------------------------------------------------
프로그램ID    : LOSTE110P (보험금지급단말기 매각 취소등록)
프로그램 종류 : Online
작성자	      : 최 대 성
작성일	      : 2012. 01. 20
완료일	      : ####. ##. ##
...
const
  TITLE   = '보험금지급단말기 매각 취소등록';
  PGM_ID  = 'LOSTE110P';

type
  Tfrm_LOSTE110P = class(TForm)
    Bevel2: TBevel;
...
function Tfrm_LOSTE110P.keyCheck:boolean;
begin
	result:= True;
...
procedure Tfrm_LOSTE110P.AttachOnKeyPressEvent;
begin
...
(*                                                                            *)
(******************************************************************************)
procedure Tfrm_LOSTE110P.OnKeyPress(Sender: TObject; var Key: Char);
var
  edit:TEdit;
  dedit:TDateEdit;
  medit:TMaskEdit;
...
(*                                                                            *)
(******************************************************************************)
procedure Tfrm_LOSTE110P.OnSearchClick(Sender:TObject);
begin
    //성명
    if Sender = btn1 then
      begin
...
(******************************************************************************)
procedure Tfrm_LOSTE110P.OnExit(Sender:TObject);
var
  edit  :TEdit;
  dedit :TDateEdit;
  medit :TMaskEdit;
...
(*                                                                            *)
(******************************************************************************)
procedure Tfrm_LOSTE110P.DetachOnEnterEvent;
begin
...
(*                                                                            *)
(******************************************************************************)
procedure Tfrm_LOSTE110P.AttachOnExitEvent;
begin
...
(*                                                                            *)
(******************************************************************************)
procedure Tfrm_LOSTE110P.AttachOnEnterEvent;
begin
...
(******************************************************************************)
procedure Tfrm_LOSTE110P.OnEnter(Sender:TObject);
var
  edit  :TEdit;
  dedit :TDateEdit;
  medit :TMaskEdit;
...
(*                                                                            *)
(******************************************************************************)
procedure Tfrm_LOSTE110P.SetItemNo(number:String);
begin
    itemNo  := number;
    value1  :='';
    value2  :='';
...
procedure Tfrm_LOSTE110P.Link_rtn (var Msg : TMessage);
var
  (**************************************************)
  (*  localcloud.pas                                *)
  (*  type :TPSharedMem                             *)
...
// 모델콤보 클릭시 이벤트
procedure Tfrm_LOSTE110P.md_cb1ButtonClick(Sender: TObject);
begin
...
// 모델 콤보 KeyUp 이벤트
procedure Tfrm_LOSTE110P.md_cb1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  i : integer;
begin
...
// 모델 그리드 클릭시
procedure Tfrm_LOSTE110P.md_grid1Click(Sender: TObject);
begin
   md_cb1.text := md_grid1.Cells[0,md_grid1.row];
   md_cb1.SetFocus;
   md_grid1.Visible := false;
...
procedure Tfrm_LOSTE110P.FormCreate(Sender: TObject);
begin
...
(*                                                                            *)
(******************************************************************************)
procedure Tfrm_LOSTE110P.InitComponents;
var
  i : Integer;
...
procedure Tfrm_LOSTE110P.btn_AddClick(Sender: TObject);
...
//'수정' 버튼 클릭
procedure Tfrm_LOSTE110P.btn_UpdateClick(Sender: TObject);
begin
  btn_AddClick(Sender);
end;

procedure Tfrm_LOSTE110P.btn_DeleteClick(Sender: TObject);
	Label LIQUIDATION;
begin
...
procedure Tfrm_LOSTE110P.btn_InquiryClick(Sender: TObject);
var
  // 암호화 관련 변수
...
begin
  ...
  (* 가입자우편번호          *)   lbl_Pt_No.Caption :=           Trim(TMAX.RecvString('STR115',0));
...
procedure Tfrm_LOSTE110P.btn_CloseClick(Sender: TObject);
begin
    //호출한 APP가 살이 있으면 메세지....
...
//On-Exit (입고일자)
procedure Tfrm_LOSTE110P.dte_Ip_DtExit(Sender: TObject);
begin
{
     try
...
function Tfrm_LOSTE110P.ExecExternProg(progID:String):Boolean;
var
	commandStr:String;
	ret:Integer;
begin
...
procedure Tfrm_LOSTE110P.FormShow(Sender: TObject);
begin
  //콤포넌트 초기화
  InitComponents;
end;

procedure Tfrm_LOSTE110P.btn_resetClick(Sender: TObject);
begin
  self.InitComponents;
end;
