...
const
	titles: Array[0..11] of String =(
            ...
            '지연');
type
TLOSTC260Q_PRT_HEAD = class(TObject)
public
...
private
	len: Array[0..11] of Cardinal;
	xRpoints:Array[0..11] of Cardinal;
end;

implementation

function TLOSTC260Q_PRT_HEAD.getLength(index :Integer):Cardinal;
begin
	result:= len[index];
...
function TLOSTC260Q_PRT_HEAD.getRightPosition(index: Integer):Cardinal;
begin
...
Constructor TLOSTC260Q_PRT_HEAD.Create(margin, maxWidth:Integer; Canvas:TCanvas);
var
	i:Integer;
    gap:Integer;
    xstart:Integer;
