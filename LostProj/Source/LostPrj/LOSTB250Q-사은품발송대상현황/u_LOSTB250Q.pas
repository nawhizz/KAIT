...
begin
	Proc_gridtoexcel('조회관리(LOSTB250Q)',grd_display.RowCount, grd_display.ColCount, grd_display, 'LOSTB250Q');
end;

procedure Tfrm_LOSTB250Q.btn_PrintClick(Sender: TObject);
var
	head:TLOSTB250Q_PRT_HEAD;	//head 계산
	Canvas: TCanvas;
	i, j, page : integer;
...
begin
  ...
  //위치 중요
  head        := TLOSTB250Q_PRT_HEAD.Create(prntMargin, prntWidth, Canvas);  //마진, 전체폭,...
