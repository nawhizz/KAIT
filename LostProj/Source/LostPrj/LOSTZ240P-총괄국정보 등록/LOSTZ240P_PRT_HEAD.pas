...
const
	titles: Array[0..12] of String =(
          ...
          '총괄국여부' );
type
TLOSTZ240P_PRT_HEAD = class(TObject)
public
...
private
	len: Array[0..12] of Cardinal;
	xRpoints:Array[0..12] of Cardinal;
end;

implementation

function TLOSTZ240P_PRT_HEAD.getLength(index :Integer):Cardinal;
begin
	result:= len[index];
...
function TLOSTZ240P_PRT_HEAD.getRightPosition(index: Integer):Cardinal;
begin
...
Constructor TLOSTZ240P_PRT_HEAD.Create(margin, maxWidth:Integer; Canvas:TCanvas);
var
	i:Integer;
    gap:Integer;
    xstart:Integer;
