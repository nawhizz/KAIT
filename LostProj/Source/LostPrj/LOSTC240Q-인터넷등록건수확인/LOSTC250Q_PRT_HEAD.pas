...
const
	titles: Array[0..3] of String =(
            ...
            '인터넷 등록건수');
type
TLOSTC240Q_PRT_HEAD = class(TObject)
public
...
private
	len: Array[0..3] of Cardinal;
	xRpoints:Array[0..3] of Cardinal;
end;

implementation

function TLOSTC240Q_PRT_HEAD.getLength(index :Integer):Cardinal;
begin
	result:= len[index];
...
function TLOSTC240Q_PRT_HEAD.getRightPosition(index: Integer):Cardinal;
begin
...
Constructor TLOSTC240Q_PRT_HEAD.Create(margin, maxWidth:Integer; Canvas:TCanvas);
var
	i:Integer;
    gap:Integer;
    xstart:Integer;
