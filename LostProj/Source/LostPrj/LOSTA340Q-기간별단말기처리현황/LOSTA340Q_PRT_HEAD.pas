...
const
	titles1: Array[0..5] of String =(
         ...
         ,'보험사매각(경찰)');
type
TLOSTA340Q_PRT_HEAD = class(TObject)
public
...
function TLOSTA340Q_PRT_HEAD.getLength(index :Integer):Cardinal;
begin
	result:= len[index];
...
function TLOSTA340Q_PRT_HEAD.getRightPosition(index: Integer):Cardinal;
begin
...
Constructor TLOSTA340Q_PRT_HEAD.Create(margin, maxWidth:Integer; Canvas:TCanvas);
var
  i:Integer;
  gap:Integer;
  xstart:Integer;
begin
  ...
  for i:=0 to 5 do
  len[i] := Canvas.TextWidth(titles1[i]);
