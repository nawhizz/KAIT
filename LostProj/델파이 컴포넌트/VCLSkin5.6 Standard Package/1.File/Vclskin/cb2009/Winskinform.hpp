...
// (DO NOT EDIT: machine generated header) 'Winskinform.pas' rev: 20.00
...
private:
	typedef DynamicArray<TMenuBtn*> _TWinSkinMenu__1;
...
private:
	typedef DynamicArray<TWinSysButton*> _TWinSkinForm__1;
...
private:
	...
	void __fastcall DoDrawText(Menus::TMenuItem* item, Graphics::TCanvas* ACanvas, const System::WideString ACaption, Types::TRect &Rect, bool Selected, int Flags);
	void __fastcall OnTimer(System::TObject* Sender);
	void __fastcall CancelMenu(void);
	TMenuBtn* __fastcall FindButtonFromAccel(System::Word Accel);
	...
	System::UnicodeString __fastcall GetSysBtnHint(int i);
...
protected:
	...
	bool __fastcall Find3rdControl(System::UnicodeString aname, Controls::TWinControl* comp);
...
public:
	...
	int mode;
	System::UnicodeString formclass;
	...
	void __fastcall AddSysMenuitem(System::UnicodeString acaption, int action);
...
extern PACKAGE StaticArray<System::WideChar, 13> c_demo;
...
extern PACKAGE System::WideString __fastcall GetFormCaption(unsigned ahwnd);
extern PACKAGE System::UnicodeString __fastcall GetFormCaptionA(unsigned ahwnd);
extern PACKAGE System::UnicodeString __fastcall GetFormText(unsigned ahwnd);
extern PACKAGE bool __stdcall EnumControl(HWND ahwnd, int lParam);
extern PACKAGE System::UnicodeString __fastcall GetWindowClassname(unsigned ahwnd);
extern PACKAGE System::UnicodeString __fastcall MsgtoStr(const Messages::TMessage &aMsg);
...
extern PACKAGE HRGN __fastcall BitmapToRegion(Graphics::TBitmap* bmp, int xx, int yy, Graphics::TColor TransparentColor = (Graphics::TColor)(0xff00ff), System::Byte RedTol = (System::Byte)(0x1), System::Byte GreenTol = (System::Byte)(0x1), System::Byte BlueTol = (System::Byte)(0x1));
...
extern PACKAGE void __fastcall SkinAddLog(System::UnicodeString msg);
