...
public:
	...
	void __fastcall DrawMenuItem(System::TObject* Sender, Graphics::TCanvas* ACanvas, const Windows::TRect 
		&ARect, bool Selected);
...
public:
	#pragma option push -w-inl
	/* TComponent.Create */ inline __fastcall virtual TWinSkinSpy(Classes::TComponent* AOwner) : Classes::TComponent(
		AOwner) { }
	#pragma option pop
...
extern PACKAGE void __fastcall DrawBGbmp(Graphics::TCanvas* acanvas, const Windows::TRect &Dst, Graphics::TBitmap* 
	Bitmap, const Windows::TRect &SrcRect);
extern PACKAGE HRGN __fastcall BitmapToRegion(Graphics::TBitmap* bmp, int xx, int yy, Graphics::TColor 
	TransparentColor, Byte RedTol, Byte GreenTol, Byte BlueTol);
extern PACKAGE void __fastcall DrawRect2(HDC DC, const Windows::TRect &Dst, Graphics::TBitmap* Bmp, 
	const Windows::TRect &Src, int I, int N, int Trans, int Tile, int Spliter);
extern PACKAGE void __fastcall DrawRectTile(Graphics::TCanvas* acanvas, const Windows::TRect &Dst, Graphics::TBitmap* 
	Bmp, const Windows::TRect &Src, int I, int N, int Trans, int Spliter);
extern PACKAGE Graphics::TBitmap* __fastcall GetHMap(const Windows::TRect &Dst, Graphics::TBitmap* Bmp
	, const Windows::TRect &Src, int I, int N, int Tile, int Spliter);
extern PACKAGE void __fastcall DrawBorder(HDC Dc, const Windows::TRect &Dst, Graphics::TBitmap* Bmp, 
	const Windows::TRect &Src, int I, int N, int Tile, int Spliter);
extern PACKAGE Graphics::TBitmap* __fastcall GetThumbMap(const Windows::TRect &Dst, Graphics::TBitmap* 
	Bmp, const Windows::TRect &Src, int I, int N, int Tile, int Spliter);
extern PACKAGE int __fastcall Max(const int A, const int B);
extern PACKAGE int __fastcall Min(const int A, const int B);
extern PACKAGE void __fastcall Bitmapdraw(HDC DC, const Windows::TRect &Dst, Graphics::TBitmap* Bmp)
	;
extern PACKAGE void __fastcall DrawRect1(HDC DC, const Windows::TRect &Dst, Graphics::TBitmap* Bmp, 
	int I, int N, int Trans);
extern PACKAGE void __fastcall DrawRect3(HDC DC, const Windows::TRect &Dst, Graphics::TBitmap* Bmp, 
	int I, int N, int Trans);
extern PACKAGE void __fastcall DrawRectH(HDC DC, const Windows::TRect &Dst, Graphics::TBitmap* Bmp, 
	const Windows::TRect &Src, int I, int N, int Tile, int Spliter);
extern PACKAGE void __fastcall DrawRectV(HDC DC, const Windows::TRect &Dst, Graphics::TBitmap* Bmp, 
	const Windows::TRect &Src, int I, int N, int Tile, int Spliter);
extern PACKAGE void __fastcall DrawParentImage(Controls::TControl* Control, HDC DC, bool InvalidateParent
	);
extern PACKAGE void __fastcall DrawTranmap(HDC DC, const Windows::TRect &Dst, Graphics::TBitmap* temp
