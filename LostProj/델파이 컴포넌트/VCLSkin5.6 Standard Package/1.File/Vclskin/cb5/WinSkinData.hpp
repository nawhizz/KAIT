...
// (DO NOT EDIT: machine generated header) 'WinSkinData.pas' rev: 5.00
...
enum TWinContainer { xccForm, xccFrame, xccToolbar, xccCoolbar, xccControlbar, xccPanel, xccScrollBox, 
	xccGroupBox, xccTabSheet, xccPageScroller };
#pragma option pop

typedef Set<TWinContainer, xccForm, xccPageScroller>  TWinContainers;

#pragma option push -b-
enum TSkinOption { xoMDIScrollbar, xoMenuMerge, xoTransparent, xoPreview, xoParentBackGround, xoNoFocusRect, 
	xoToolbarBK, xoToolbarButton, xoMDIChildBorder, xoMenuBG, xoCaptionButtonHint, xoFormScrollbar };
#pragma option pop

typedef Set<TSkinOption, xoMDIScrollbar, xoFormScrollbar>  TSkinOptions;

#pragma option push -b-
enum TSkinControlType { xcMainMenu, xcPopupMenu, xcMenuItem, xcToolbar, xcControlbar, xcCombo, xcCheckBox, 
	xcRadioButton, xcProgress, xcScrollbar, xcEdit, xcButton, xcBitBtn, xcSpeedButton, xcSpin, xcPanel, 
	xcGroupBox, xcStatusBar, xcTab, xcTrackBar, xcSystemMenu, xcFastReport };
#pragma option pop

typedef Set<TSkinControlType, xcMainMenu, xcFastReport>  TSkinControlTypes;

#pragma option push -b-
enum TShemeColor { csText, csTitleTextActive, csTitleTextNoActive, csButtonFace, csButtonText, csButtonHilight, 
	csButtonlight, csButtonShadow, csButtonDkshadow, csSelectText, csSelectBg, csHilightText, csHilight, 
	csMenuBar, csMenuBarText, csMenuText, csMenubg, csCaption, csScrollbar, csTextDisable };
#pragma option pop
...
typedef void __fastcall (__closure *TOnSkinControl)(Classes::TComponent* Sender, TSkinData* SkinData
	, Controls::TControl* Form, Controls::TControl* Control, AnsiString ControlClass, Classes::TComponent* 
	&SkinnedControl);
...
public:
	...
	/* TDataSkinObject.Create */ inline __fastcall TDataSkinTitle(AnsiString AIDName) : TDataSkinObject(
		AIDName) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TDataSkinObject.Create */ inline __fastcall TDataSkinSysButton(AnsiString AIDName) : TDataSkinObject(
		AIDName) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TDataSkinObject.Create */ inline __fastcall TDataSkinBoxLabel(AnsiString AIDName) : TDataSkinObject(
		AIDName) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	...
	void __fastcall UpdateSkinControl(Forms::TForm* fParent, Controls::TWinControl* acontrol);
	...
	void __fastcall ActivateHint(const Windows::TRect &aRect, const AnsiString AHint);
...
extern PACKAGE int __fastcall Tnt_DrawTextW(HDC hDC, WideString wString, Windows::TRect &lpRect, unsigned 
	uFormat);
