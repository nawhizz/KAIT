    ...
    begin
      ...
      begin
         if (component as TSpeedButton).Name = 'btn_Add' then
           ...
           begin
             bitmap.LoadFromFile(Loc + '¿Œº‚.bmp');
             (component as TSpeedButton).Glyph := bitmap;
           end
         else if (component as TSpeedButton).Name = 'btn_Excel' then
           begin
             bitmap.LoadFromFile(Loc + 'ø¢ºø.bmp');
             (component as TSpeedButton).Glyph := bitmap;
           end
