...
begin
  ...
  encdata := ECPlazaSeed.Encrypt(data, userkey);
  //encdata := ECPlazaSeed.Encrypt(Edit1.Text, userkey);
...
begin
  ...
  decdata := ECPlazaSeed.Decrypt(data, userkey);
  //decdata := ECPlazaSeed.Decrypt(Edit2.Text, userkey);
